...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">
                <i class="fa-solid fa-users"></i> Users List ({{ $record->total() }})
            </h5>

            <form action="{{ url('/admin/users') }}" method="GET" class="d-flex align-items-center" style="gap: 20px;">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <a href="{{ route('admin.users.export') }}" class="btn btn-success text-nowrap">
                        Export Excel
                    </a>
                </div>
